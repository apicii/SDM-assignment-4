 ...
 */
package ch.usi.si.codelounge.jsicko.tutorials;

import java.util.Collection;
import java.util.List;
import java.util.ListIterator;

import ch.usi.si.codelounge.jsicko.tutorials.Transformer;
import ch.usi.si.codelounge.jsicko.tutorials.TransformedCollection;
import ch.usi.si.codelounge.jsicko.tutorials.AbstractListIteratorDecorator;
